...
# load all dataset modules in local data package (exclude dunder files)
dataset_filenames = [
    osp.splitext(osp.basename(v))[0] for v in scandir(data_folder, suffix='.py')
    if not osp.basename(v).startswith('__')
]
